...
print 'The batch_size is ' + str(batch_size)



#============ Load the data and divided in patches
patches_imgs_train, patches_masks_train = get_data_training(
    DL_train_imgs_original = path_data + config.get('data paths', 'train_imgs_original'),
    DL_train_groudTruth = path_data + config.get('data paths', 'train_groundTruth'),  #masks
